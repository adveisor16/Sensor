...
void loop() {
  ...
  */
  ...
  if ( currentMillis - previousMillis >= SampleTime ) {
    ...
    filterX = 0.95 * (filterX + Gyro_X * dt) + 0.05 * RollAccel;
    filterY = 0.95 * (filterY + Gyro_Y * dt) + 0.05 * PitchAccel;
