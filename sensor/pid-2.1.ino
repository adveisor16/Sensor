...
#define OUT_MIN -300
  ...
  double Setpoint, gyroZ, Input2, Input3, pidGyroZ, Output2, Output3;
  PID myPID1(&gyroZ, &pidGyroZ, &Setpoint,3,0.01,0.01, DIRECT);
...
void setup() {
  ...
  myPID1.SetOutputLimits(OUT_MIN, OUT_MAX);
}
